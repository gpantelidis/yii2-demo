    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Lessons Table</h1>
                <!-- DataTales -->
                <?= Html::a('Create new', ['lessonscreate'], ['class' => 'btn btn-primary mb-2']) ?>
                                    ...
                                    <?php if (is_array($lessons) && count($lessons) > 0) : ?>
                                        <?php foreach ($lessons as $lesson) : ?>
                                            <tr>
                                                ...
                                                <td><?= $lesson->name ?></td>
                                                <td><?php
                                                    if (strlen($lesson->description) > 20) {
                                                        echo substr($lesson->description, 0, 20) . '...';
                                                    } else {
                                                        echo $lesson->description;
                                                    }
                                                    ?></td>
                                                <td><?= $lesson->create_dt ?></td>
                                                <td>
                                                    <span><?= Html::a('View', ['lessonsview', 'id' => $lesson->id], ['class' => 'btn btn-primary']) ?></span>
                                                    <span><?= Html::a('Edit', ['lessonsedit', 'id' => $lesson->id], ['class' => 'btn btn-secondary']) ?></span>
                                                    <span><?= Html::a('Delete', ['lessonsdelete', 'id' => $lesson->id], ['class' => 'btn btn-danger']) ?></span>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
